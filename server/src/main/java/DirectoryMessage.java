...
public class DirectoryMessage extends AbstractMessage {
    ...
    private FileInfo directoryItem;
    //объявляем массив со списком объектов в директории
    private FileInfo[] itemsList;
    ...
    public DirectoryMessage(FileInfo directoryItem, FileInfo[] itemsList) {
    ...
    public FileInfo getDirectoryItem() {
        return directoryItem;
    }

    public FileInfo[] getItemsList() {
        return itemsList;
    }
