...
public class PropertiesClientHandler {
    //инициируем синглтон хендлера настроек
    private static final PropertiesClientHandler ownObject = new PropertiesClientHandler();

    public static PropertiesClientHandler getOwnObject() {
        return ownObject;
    }
    ...
    /**
     * Метод первом запуске приложения создает копию конфигурационного файла.
